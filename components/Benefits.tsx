  ...
  return (
    <section className="padding-variable bg-gradient">
      <div className="pb-14 mx-auto">
        <h2 className="hidden md:block font-Montserrat text-5xl md:text-6xl text-center text-white pb-6 capitalize">
        Benefits of getting a website built from us
        </h2>
        <h2 className="md:hidden font-Montserrat text-5xl md:text-7xl text-center text-white pb-6 capitalize">
        Benefits
        </h2>
        <hr className="w-60 mx-auto  bg-white p-0.5 border-t-0 rounded-md" />
      </div>
