  ...
  return (
    <section className="padding-variable py-6 md:py-10 lg:py-[60px]">
      <div className="pb-10 mx-auto">
        <h2 className="font-Gothic text-5xl md:text-7xl text-center text-default capitalize text-gradient">
      ...
      >
        ...
        <SwiperSlide className='relative font-Merri bg-black-gradient text-default rounded-r-lg p-6 m-auto'>
