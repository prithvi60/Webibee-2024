...
const Hero = () => {
  return (
    <section className="padding-variable text-center text-white  bg-[#904BF6]
    ">
      ...
      <div className="flex justify-around items-center gap-3 border-2 border-[#14A800] py-3 px-2 w-full lg:w-1/2 mx-auto rounded-xl">
        <h4 className="hidden md:flex items-center gap-2 text-sm md:text-lg font-Lato font-semibold">
          <span className="p-1.5 rounded-full bg-[#14A800]"><LuCrown className="h-5 w-5  text-white "/></span>
          100% Job Success
        </h4>
        <Link target="blank" href={"https://www.upwork.com/freelancers/~01d7976a7b95d87d71?viewMode=1"}>
        ...
        <h4 className="flex flex-col justify-center md:flex-row items-center gap-1 md:gap-2 text-sm md:text-xl font-urbanist font-bold">
          <span className="p-1 md:p-1.5 rounded-full mx-2 bg-[#14A800] w-max"><TiStarOutline className="w-3 h-3 md:h-5 md:w-5 text-white "/></span>
      ...
      >
        <Link target="blank" href={"https://calendar.app.google/dUU7BcdHo1Y61M1v6"}>
          Free Consultation
        </Link>
      </Button>
    </section>
