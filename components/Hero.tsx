  ...
  return (
    <>
      <section
        ...
        style={{ zIndex: 2 }}
      >
        <h2 className="capitalize  text-6xl md:text-8xl w-full mx-auto tracking-wide font-caveat font-medium mt-16">
        ...
        <div className="pt-8">
          <Button
            size="lg"
            radius="lg"
            className="px-6 py-5 font-urbanist text-xl md:text-2xl font-bold text-default shadow-lg bg-danger"
          >
            <Link
              target="blank"
