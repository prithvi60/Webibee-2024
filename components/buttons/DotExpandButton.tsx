...
const DotExpandButton = ({ text, href }: { text: string, href: string }) => {
    return (
        <section className="grid">
            <Link href={href} className="mx-auto cursor-none">
                <button type="button" title={text} className="group flex h-10 items-center gap-2 rounded-md pl-8 pr-8 transition-all duration-300 ease-in-out hover:bg-info/80 uppercase hover:pl-2 py-8 font-SourceCodePro text-base border-2 sm:text-lg xl:text-xl hover:text-white active:bg-neutral-700">
