...
const ContactForm = () => {
    return (
        <section className="w-full p-10 sm:px-20 xl:px-64 sm:py-16 xl:py-28 flex gap-20 items-center">
            <div className="w-full md:w-2/5 space-y-7 md:space-y-14">
                <h3 className="font-EbGaramond font-medium text-5xl sm:text-7xl xl:text-8xl text-center md:text-start">
            ...
            <form className="w-full md:w-3/5">
                <div className="flex flex-col gap-6">
                    <input
                        ...
                        className="bg-info/40 text-base md:text-lg font-SourceCodePro focus:ring-1 px-5 py-3 placeholder:text-[#757272] focus:outline-info/80"
                    />
                    <input
                        type="email"
